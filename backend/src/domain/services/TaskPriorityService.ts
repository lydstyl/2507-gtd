import { TaskWithSubtasks } from '../entities/Task'
...
export class TaskPriorityService {
   ...
   */
  static getEffectiveDate(task: TaskWithSubtasks, context: DateContext): Date | null {
   ...
   */
  static isCollectedTask(task: TaskWithSubtasks, context: DateContext): boolean {
   ...
   */
  static isOverdueTask(task: TaskWithSubtasks, context: DateContext): boolean {
    const effectiveDate = this.getEffectiveDate(task, context)
   ...
   */
  static isTodayTask(task: TaskWithSubtasks, context: DateContext): boolean {
    const effectiveDate = this.getEffectiveDate(task, context)
   ...
   */
  static isTomorrowTask(task: TaskWithSubtasks, context: DateContext): boolean {
    const effectiveDate = this.getEffectiveDate(task, context)
   ...
   */
  static isFutureTask(task: TaskWithSubtasks, context: DateContext): boolean {
    const effectiveDate = this.getEffectiveDate(task, context)
   ...
   */
  static getTaskCategory(task: TaskWithSubtasks, context: DateContext): TaskCategory {
   ...
   */
  static compareByCategory(a: TaskWithSubtasks, b: TaskWithSubtasks, context: DateContext): number {
   ...
   */
  static compareByEffectiveDate(a: TaskWithSubtasks, b: TaskWithSubtasks, context: DateContext): number {
   ...
   */
  static compareTasksPriority(a: TaskWithSubtasks, b: TaskWithSubtasks, context: DateContext): number {
    const categoryA = this.getTaskCategory(a, context)
