...
describe('Task Sorting Tests', () => {
  ...
  test('should sort tasks according to points system', async () => {
    ...
    const testTasks = [
      ...
      { name: 'Tâche haute priorité 1', importance: 50, complexity: 1, plannedDate: null }, // 500 points
      { name: 'Tâche haute priorité 2', importance: 40, complexity: 1, plannedDate: null }, // 400 points

      // 2. Tâches pour aujourd'hui
      { name: 'Tâche aujourd\'hui - Moyenne', importance: 30, complexity: 3, plannedDate: new Date() }, // 100 points
      { name: 'Tâche aujourd\'hui - Facile', importance: 25, complexity: 1, plannedDate: new Date() }, // 250 points
      { name: 'Tâche aujourd\'hui - Complexe', importance: 45, complexity: 9, plannedDate: new Date() }, // 50 points

      // 3. Tâches pour demain
      { name: 'Tâche demain - Importante', importance: 35, complexity: 2, plannedDate: new Date(Date.now() + 24 * 60 * 60 * 1000) }, // 175 points
      { name: 'Tâche demain - Simple', importance: 20, complexity: 1, plannedDate: new Date(Date.now() + 24 * 60 * 60 * 1000) }, // 200 points
