import type { Task, TaskCategory } from '../entities/Task'
 ...
 * Mirrors the backend TaskPriorityService to ensure consistency
 */
export class TaskSortingPriorityService {
  /**
   ...
   */
  static getEffectiveDate(task: Task, context: DateContext): Date | null {
   ...
   */
  static isCollectedTask(task: Task, context: DateContext): boolean {
   ...
   */
  static isOverdueTask(task: Task, context: DateContext): boolean {
    const effectiveDate = this.getEffectiveDate(task, context)
   ...
   */
  static isTodayTask(task: Task, context: DateContext): boolean {
    const effectiveDate = this.getEffectiveDate(task, context)
   ...
   */
  static isTomorrowTask(task: Task, context: DateContext): boolean {
    const effectiveDate = this.getEffectiveDate(task, context)
   ...
   */
  static isFutureTask(task: Task, context: DateContext): boolean {
    const effectiveDate = this.getEffectiveDate(task, context)
   ...
   */
  static getTaskCategory(task: Task, context: DateContext): TaskCategory {
   ...
   */
  static compareByCategory(a: Task, b: Task, context: DateContext): number {
   ...
   */
  static compareByPoints(a: Task, b: Task): number {
   ...
   */
  static compareByEffectiveDate(a: Task, b: Task, context: DateContext): number {
   ...
   */
  static compareTasksPriority(a: Task, b: Task, context: DateContext): number {
    const categoryA = this.getTaskCategory(a, context)
