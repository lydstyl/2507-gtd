    ...
    <div className="border border-gray-300 rounded-lg overflow-hidden">
      ...
      <div className="bg-gray-50 border-b border-gray-300 p-2 flex flex-wrap gap-1">
        ...
        <button
          ...
          className={`p-2 rounded ${editor.isActive('underline') ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-200'}`}
          title="Souligné"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button
          ...
          className={`p-2 rounded ${editor.isActive('strike') ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-200'}`}
          title="Barré"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button
          ...
          className={`p-2 rounded ${editor.isActive('heading', { level: 1 }) ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-200'}`}
          title="Titre 1"
        >
          H1
        </button>
        ...
        <button
          ...
          className={`p-2 rounded ${editor.isActive('heading', { level: 2 }) ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-200'}`}
          title="Titre 2"
        >
          H2
        </button>
        ...
        <button
          ...
          className={`p-2 rounded ${editor.isActive('heading', { level: 3 }) ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-200'}`}
          title="Titre 3"
        >
          H3
        </button>
